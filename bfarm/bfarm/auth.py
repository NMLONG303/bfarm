...
def on_login(login_manager):
	"""Ép mọi đăng nhập đưa user thẳng về workspace Bfarm Agriculture (/app/bfarm-agriculture).

	Set frappe.local.flags.home_page bằng đường dẫn TUYỆT ĐỐI khiến:
	- auth.py::set_user_info trả home_page = "/app/bfarm-agriculture"
	  -> login.js handler 200 navigate tới URL tuyệt đối /app/bfarm-agriculture.
	...
	frappe.local.flags.home_page = "/app/bfarm-agriculture"
